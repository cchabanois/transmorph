...
@SuiteClasses(value = { StringToURITest.class, IdentityConverterTest.class,
		...
		CharacterArrayToStringTest.class, StaticConverterTest.class,
		SingleElementToArrayTest.class, StringToStringBuilderTest.class,
		ClassToStringTest.class, SingleElementToCollectionTest.class,
