...
public class TypeSignatureFactoryTest extends TestCase {
	...
	public void testClassTypeSignature() {
		TypeSignature typeSignature = TypeSignatureFactory.getTypeSignature(String.class);
	...
	public void testArrayTypeSignature() {
		TypeSignature typeSignature = TypeSignatureFactory.getTypeSignature((new String[5][5]).getClass());
		assertTrue(typeSignature.isArrayType());
		assertEquals("[[Ljava/lang/String;", typeSignature.getSignature());
	}
	
	public void testPrimitiveTypeSignature() {
		TypeSignature typeSignature = TypeSignatureFactory.getTypeSignature(Integer.TYPE);
	...
	public void testParameterizedTypeSignature() {
		TypeSignature typeSignature = TypeSignatureFactory.getTypeSignature(Map.class, new Class[] { String.class, Integer.class });
		assertTrue(typeSignature.isClassType());
		assertEquals("Ljava/util/Map<Ljava/lang/String;Ljava/lang/Integer;>;", typeSignature.getSignature());
	}
